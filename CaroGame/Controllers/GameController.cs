...
namespace CaroGame.Controllers
{
    public class GameController : Controller
    {
		...
		public ActionResult SelectMode(bool isAI=true,bool isNormal=true)
		{
            GameState st = state;
            st.IsNormal= isNormal;
            st.IsAIMode = isAI;
            st.IsOver = false;
            st.Winner = 0;
            st.board= new Board();
		...
		public ActionResult AfterClick_AI_Mode(int r,int c)
		{
            ...
            //Lượt của AI
            AI_Mode_Update AI = new AI_Mode_Update(st.StatsUpdate);
        ...
        //AI mode normal
        public ActionResult AfterClick_AI_Mode_Normal(int r, int c)
        {
            GameState st = state;
            ...
            //Lượt của AI
            AI_Mode_Normal AI = new AI_Mode_Normal(st.StatsNormal);
            Move AI_Move = AI.FindBestMove(st.board, st.HumanPlayer);
